  ...
  addTask(data: any): Observable<any>{
   ...
   if(list !== null){
    ...
    localStorage.setItem("todo", JSON.stringify([data]))
        ...
        return this._http.post("https://main--enchanting-marshmallow-109241.netlify.app/.netlify/functions/api/task", data)
  }

  getTaskList(): Observable<any>{
    return this._http.get("https://main--enchanting-marshmallow-109241.netlify.app/.netlify/functions/api/task")
}
...
deleteTask(id: Number): Observable<any>{
 ...
 newArray.push(myArray[index-1]);
  ...
  return this._http.delete(`https://main--enchanting-marshmallow-109241.netlify.app/.netlify/functions/api/task/${id}`)
}
}
